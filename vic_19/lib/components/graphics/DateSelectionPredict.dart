...
class DateSeleccionPredict extends StatelessWidget {
  ...
  double _height;
  bool _outlined;
  DateSeleccionPredict(this._selectedDate,this._color,this._backColor,this._width,this._height,this._outlined);
  Size size;
  @override
  ...
  _selecDate(BuildContext context) async {
    DateTime date;
    date=await showDatePicker(context: context, initialDate: _selectedDate, firstDate: DateTime.now(), lastDate: DateTime(2022),helpText: "Seleccione una fecha",fieldLabelText: "Fecha",fieldHintText: "Mes/Dia/Año",errorInvalidText: "",errorFormatText: "",
    ...
    if(date!=null && date!=_selectedDate){
        BlocProvider.of<GraphicsBloc>(context).add((GetPredictDataEvent(date)));
